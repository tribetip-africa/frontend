        ...
        <section className="bg-white pt-12 pb-8 sm:pt-16 sm:pb-10">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            <p className="mt-4 text-lg text-ink-soft">
              These terms explain the rules for using TribeTip — clearly, and without the
              jargon. Please read them carefully.
            </p>
            <p className="mt-3 text-sm text-muted">Last updated: {TERMS_LAST_UPDATED}</p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl gap-12 px-4 sm:px-6 lg:grid lg:grid-cols-[16rem_1fr]">
            ...
            <div className="min-w-0">
              <div className="surface-soft rounded-2xl p-6 text-ink-soft sm:p-8">
                <p>
                  Welcome to TribeTip. We&apos;ve written these terms to be readable. If
                  anything is unclear, our{" "}
